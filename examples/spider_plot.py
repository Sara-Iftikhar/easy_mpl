...
# specifying labels
labels = ['a', 'b', 'c', 'd', 'e', 'f']
_ = spider_plot(data=values, labels=labels)

#%%
# # specifying tick size
_ = spider_plot(values, labels, xtick_kws={'size': 13})
...
_ = spider_plot(df, xtick_kws={'size': 13})
...
#%%
_ = spider_plot(df, xtick_kws={'size': 13}, frame="polygon",
           color=['b', 'r', 'g', 'm'],
            fill_color=['b', 'r', 'g', 'm'])
